...
from dataset.info import INFO, HOMEPAGE, DEFAULT_ROOT
...
class MedMNIST(Dataset):
    ...
    def __init__(self,
        ...
        self.texts = ["This image demonstrates for {}".format(name) for name in self.info["label"].values() ]
...
class MedMNIST2D(MedMNIST):
    ...
    def __getitem__(self, index):
        ...
        img = img.resize(self.cfg.INPUT_SIZE)
...
class MedMNIST3D(MedMNIST):
    ...
    def __getitem__(self, index):
        ...
        target = "This image demonstrates for " + self.info["label"][str(target)]
